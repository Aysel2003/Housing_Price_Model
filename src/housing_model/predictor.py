...
from .schema import validate_dataframe, REQURIED_COLUMNS
...
def load_predictor(
    model_path: str, training_profile_path: str | None = None
) -> Predictor:
    model = joblib.load(model_path)
    profile = (
        _load_json_optional(training_profile_path) if training_profile_path else None
    )
